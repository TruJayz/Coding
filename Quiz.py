...
'Three built in functons are float(), help(), and Input() '
...
# Please write your response in complete sentences.
'The difference between a parameter and a argument is that.'
'A parameter tells you information can be passed to methods as parameter'
'A arugmernt is information can be passed into functions'
